...
CocktailDetailsResponse _$CocktailDetailsResponseFromJson(
  ...
  return CocktailDetailsResponse(
    drinks: (json['drinks'] as List)
        ?.map((e) => e == null
            ? null
            : CocktailDetails.fromJson(e as Map<String, dynamic>))
        ?.toList(),
  );
}
...
CocktailDetails _$CocktailDetailsFromJson(Map<String, dynamic> json) {
  return CocktailDetails(
    ...
    strDrinkZH_HANS: json['strDrinkZH-HANS'] as String,
    strDrinkZH_HANT: json['strDrinkZH-HANT'] as String,
    ...
    strInstructionsZH_HANS: json['strInstructionsZH-HANS'] as String,
    strInstructionsZH_HANT: json['strInstructionsZH-HANT'] as String,
...
Map<String, dynamic> _$CocktailDetailsToJson(CocktailDetails instance) =>
    <String, dynamic>{
